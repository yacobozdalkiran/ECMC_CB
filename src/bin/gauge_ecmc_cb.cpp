...
void testp(GaugeField& field, GeometryCB& geo, mpi::MpiTopology& topo, HalosCB& halo_cb, parity active_parity){
...
void decmc() {
    ...
    for (int i = 0; i < Ntot; i++) {
        for (int j = 0; j < Nloc; j++) {
            ...
            testp(field, geo, topo, halo_cb, active_parity);
