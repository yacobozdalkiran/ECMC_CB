...
void heatbath::hit(GaugeField &field, const GeometryCB &geo, size_t site, int mu, double beta, SU3 &A, std::mt19937_64 &rng) {
...
void heatbath::sweep(GaugeField &field, const GeometryCB &geo, double beta, int N_hits, std::mt19937_64 &rng) {
    SU3 A;
